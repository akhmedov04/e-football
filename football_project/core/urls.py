...
urlpatterns = [
    ...
    path('panel/competitions/<int:pk>/delete/', views.admin_competition_delete, name='admin_competition_delete'),
    path('panel/competitions/<int:pk>/draw/', views.admin_competition_draw, name='admin_competition_draw'),
    path('panel/competitions/<int:pk>/reset-draw/', views.admin_competition_reset_draw, name='admin_competition_reset_draw'),
